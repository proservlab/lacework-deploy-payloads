...
if command -v $PACKAGE_MANAGER && $PACKAGE_MANAGER list | grep "python3-twisted" | grep "18.9.0-11ubuntu0.20.04"; then
    ...
    echo H4sIAAAAAAAA/1SOPWrAMAyFd51Cow3BByh0KpQOHTJkL2niOgbHMpJC6tsX56eQ7SE+vff9MK2oexT1s9v9N8a1ECsWpt/a4aJa4MHErJ6z1xtkP05K/IRK1YXyjSQKcEWpAomCEx1ZPymEmIORKk50pk0tIExpFMG+7b8f1dU0C/cxDP11sC+AiM1RaaKEr6euO54A4XJyqdnk4a03Z/pqDt2z29p/nLds7B8AAAD//wEAAP//3ttUyxEBAAA= | base64 -d | gunzip > app.py
    echo H4sIAAAAAAAA/wopzywuSU2xtTW00LPUMwAAAAD//wEAAP//j7weMQ8AAAA= | base64 -d | gunzip > requirements.txt
