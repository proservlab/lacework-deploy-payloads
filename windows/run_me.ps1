...
$attacker_asset_inventory = Get-Base64GzipString -Base64Payload $env_context["attacker_asset_inventory"]
$target_asset_inventory = Get-Base64GzipString -Base64Payload $env_context["target_asset_inventory"]
